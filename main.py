...
from view import bar_valores, inserir_categoria, pie_valores, percentagem_valor, ver_categoria, inserir_receitas, \
  inserir_gastos, tabela, deletar_gastos, deletar_receitas
...
style.configure("Treeview", highligtthickness=0, bd=0, font=('Calibri', 9))
...
def grafico_bar():
  ...
  # faca figura e atribua a objetos de eixo
...
def resumo():
  ...
  l_sumario = Label(frameMeio, text="Total Renda Mensais    ".upper(), height=1, anchor=NW, font=('Verdana 12'), bg=co1,
                    fg='#83a9e6')
  l_sumario.place(x=306, y=35)
  l_sumario = Label(frameMeio, text="R$ {:,.2f}".format(valor[0]), height=1, anchor=NW, font=('arial 17'), bg=co1,
                    fg='#545454')
  l_sumario.place(x=306, y=70)

  l_linha = Label(frameMeio, text="", width=215, height=1, anchor=NW, font=('arial 1'), bg='#545454')
  l_linha.place(x=309, y=132)
  l_sumario = Label(frameMeio, text="Total Despesas Mensais  ".upper(), height=1, anchor=NW, font=('Verdana 12'),
                    bg=co1, fg='#83a9e6')
  l_sumario.place(x=306, y=115)
  l_sumario = Label(frameMeio, text="R$ {:,.2f}".format(valor[1]), height=1, anchor=NW, font=('arial 17'), bg=co1,
                    fg='#545454')
  l_sumario.place(x=306, y=150)

  l_linha = Label(frameMeio, text="", width=215, height=1, anchor=NW, font=('arial 1'), bg='#545454')
  l_linha.place(x=309, y=207)
  l_sumario = Label(frameMeio, text="Total Saldo da Caixa   ".upper(), height=1, anchor=NW, font=('Verdana 12'), bg=co1,
                    fg='#83a9e6')
  l_sumario.place(x=309, y=190)
  l_sumario = Label(frameMeio, text="R$ {:,.2f}".format(valor[2]), height=1, anchor=NW, font=('arial 17'), bg=co1,
                    fg='#545454')
...
l_info = Label(frame_operacoes, text='Insira Novas Despesas', height=1, anchor=NW, font=('Verdana 10 bold'), bg=co1,
               fg=co4)
...
botao_inserir_despesas = Button(frame_operacoes, command=inserir_despesas_b, image=img_add_despesas,
                                text=" Adicionar".upper(), width=80, compound=LEFT, relief=RAISED, anchor=NW,
...
img_delete_despesas = Image.open('deletar.png')
img_delete_despesas = img_delete_despesas.resize((17, 17))
img_delete_despesas = ImageTk.PhotoImage(img_delete_despesas)

botao_deletar_despesas = Button(frame_operacoes, command=deletar_dados, image=img_delete_despesas,
                                text=" Deletar".upper(), width=80, compound=LEFT, relief=RAISED, anchor=NW,
                                font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
botao_deletar_despesas.place(x=110, y=190)

# Configuracao Receitas -----------------------

l_info = Label(frame_configuracao, text='Insira Novas Receitas', height=1, anchor=NW, font=('Verdana 10 bold'), bg=co1,
               fg=co4)
l_info.place(x=10, y=10)
...
botao_inserir_receitas = Button(frame_configuracao, command=inserir_receitas_b, image=img_add_receitas,
                                text=" Adicionar".upper(), width=80, compound=LEFT, relief=RAISED, anchor=NW,
                                font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
...
botao_inserir_receitas = Button(frame_configuracao, command=inserir_categoria_b, image=img_add_receitas,
                                text=" Adicionar".upper(), width=80, compound=LEFT, relief=RAISED, anchor=NW,
                                font=('Ivy 7 bold'), bg=co1, fg=co0, overrelief=RIDGE)
